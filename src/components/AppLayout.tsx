...
export default function AppLayout({ children }: { children: React.ReactNode }) {
    ...
    const navigation = [
        ...
        { name: 'Levels', href: '/app/levels', icon: BookOpen },
        { name: 'AI Assistant', href: '/app/chat', icon: Brain },
        { name: 'My Materials', href: '/app/storage', icon: Files },
        // { name: 'Example Table', href: '/app/table', icon: LucideListTodo }, // Hidden for now, keep for admin later
