...
// Temporary types for backward compatibility (table feature hidden but code preserved)
type Task = {
    id: number;
    title: string;
...
function CreateTaskDialog({ onTaskCreated }: CreateTaskDialogProps) {
    ...
    const handleAddTask = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            // Temporary: newTask not used while table feature is hidden
            const { error: supabaseError } = await supabase.createTask();
...
export default function TaskManagementPage() {
    ...
    const loadTasks = useCallback(async (): Promise<void> => {
        try {
            ...
            // Temporary: table feature hidden, will be restored with proper task management
            // const supabase = await createSPASassClient();
